...
//        BeerPagedList list = new BeerPagedList(Arrays.asList(beerDto));
        ...
        BeerOrder savedBeerOrder2 = beerOrderRepository.findOneById(savedBeerOrder.getId());
...
//        BeerPagedList list = new BeerPagedList(Arrays.asList(beerDto));
        ...
        BeerOrder beerOrder = createBeerOrder();
        beerOrder.setCustomerRef("partial-validation");
...
//        BeerPagedList list = new BeerPagedList(Arrays.asList(beerDto));
        ...
        assertThat(deallocateOrderRequest.getBeerOrderDto()).isEqualTo(savedBeerOrder.getId());
    }
